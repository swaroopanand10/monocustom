local highlights = {
		...
		CursorLineNr = {fg = C.blue0, style = "bold", },
		...
		Visual = { bg = C.dark2, },
		VisualNOS = {bg = C.dark2,fg = C.red4,},
		...
		String = {fg = C.yellow1, },
		Character = {fg = C.yellow1, },
		Constant = {fg = C.purple0, },
		Number = {fg = C.purple0, },
		Boolean = {fg = C.blue, },
		Float = {fg = C.cyan, },
		...
		Conditional = {fg = C.red0, style = "italic", },
		Repeat = {fg = C.purple, style = "italic" },
		Label = {fg = C.red0, },
		Exception = {fg = C.purple, },
		Include = {fg = C.red0,style = "bold", },
		PreProc = {fg = C.purple, },
		Define = {fg = C.red0, "bold", },
		Macro = {fg = C.purple, },
		PreCondit = {fg = C.red0, },
		Special = {fg = C.red0, },
		SpecialChar = {fg = C.red0, },
		Tag = {fg = C.red0, style="bold", },
		Debug = {fg = C.red, },
		Delimiter = {fg = C.red0, },
